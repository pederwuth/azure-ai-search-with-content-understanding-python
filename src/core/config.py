...
class Settings:
    ...
    def __init__(self):
        ...
        self.azure_openai_chat_api_version = os.getenv("AZURE_OPENAI_CHAT_API_VERSION", "2024-12-01-preview")
        self.azure_openai_embedding_deployment_name = os.getenv("AZURE_OPENAI_EMBEDDING_DEPLOYMENT_NAME")
        self.azure_openai_embedding_api_version = os.getenv("AZURE_OPENAI_EMBEDDING_API_VERSION", "2024-12-01-preview")
        
        # Azure Content Understanding settings
        self.azure_ai_service_endpoint = os.getenv("AZURE_AI_SERVICE_ENDPOINT")
        self.azure_ai_service_api_version = os.getenv("AZURE_AI_SERVICE_API_VERSION", "2024-12-01-preview")
        
        # Azure Document Intelligence settings (uses same endpoint as AI services)
        self.azure_document_intelligence_endpoint = os.getenv("AZURE_DOCUMENT_INTELLIGENCE_ENDPOINT") or self.azure_ai_service_endpoint
        self.azure_document_intelligence_api_version = os.getenv("AZURE_DOCUMENT_INTELLIGENCE_API_VERSION", "2024-11-30")
        
        # Azure Search settings
        self.azure_search_endpoint = os.getenv("AZURE_SEARCH_ENDPOINT")
        self.azure_search_index_name = os.getenv("AZURE_SEARCH_INDEX_NAME", "educational-content-index")
        
        # Processing settings
        self.max_completion_tokens = int(os.getenv("MAX_COMPLETION_TOKENS", "4000"))
        self.embedding_chunk_size = int(os.getenv("EMBEDDING_CHUNK_SIZE", "1000"))
        self.embedding_chunk_overlap = int(os.getenv("EMBEDDING_CHUNK_OVERLAP", "200"))
        
        # Output settings
        self.output_dir = os.getenv("OUTPUT_DIR", "educational_content")
        self.book_summaries_dir = os.getenv("BOOK_SUMMARIES_DIR", "educational_content/book_summaries")
        
        # Analyzer settings
        self.analyzer_id = os.getenv("ANALYZER_ID", "content-document-analyzer")
        self.analyzer_template_path = os.getenv("ANALYZER_TEMPLATE_PATH", "analyzer_templates/content_document.json")
    ...
    def validate(self) -> None:
        ...
        required_settings = [
            ...
            ("azure_openai_chat_deployment_name", self.azure_openai_chat_deployment_name),
